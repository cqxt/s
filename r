...
-- dne exclusive
local Library = loadstring(game:HttpGet("https://pastebin.com/raw/p7FPd9TA"))()
local LinoriaNotifs = loadstring(game:HttpGet("https://raw.githubusercontent.com/bloodball/-back-ups-for-libs/main/cat"))()
