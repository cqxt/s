--[[ hello very cool incognito / solara (mostly incognito because solara has most of these functions, just not all) script showcase and btw make sure to join https://discord.gg/BkTebksHgr for more scripts like these!!
...
do 
	...
	do 
		...
		do 
			...
			utility.drawings["Sub"] = utility:drawObject("Text", {Outline = true, Text = "Kay", Color = Color3.new(1, 1, 1)})
			utility.drawings["Domain"] = utility:drawObject("Text", {Outline = true, Text = "Flock", Color = Color3.fromRGB(255, 0, 0)})
			--
...
local Window = Library:Window({Size = UDim2.new(0,580,0,600)}) do 
	...
	local aiming = Window:Page({Name = "Rage"}) do
		...
		local targetVisuals = aiming:Section({Name = "Visuals", Size = 330, Side = "Right"}) do 
			...
			highlight:Colorpicker({Default = Color3.fromRGB(255,255,255), Alpha = 0.5, Flag = "Highlight Fill Color"});
			highlight:Colorpicker({Default = Color3.fromRGB(255,255,255), Flag = "Highlight Outline Color"});
			local backtrack = targetVisuals:Toggle({Name = "Backtrack", Flag = "Back Track Enabled"})
			backtrack:Colorpicker({Default = Color3.fromRGB(255, 255, 255), alpha = 0.65, Flag = "Back Track Settings"});
	...
	local legit = Window:Page({Name = "Legit"}) do 
		...
		local aimAssistFov = legit:Section({Name = "Field Of View", Size = 330}) do 
			...
			end}):Colorpicker({Default = Color3.fromRGB(255, 255, 255), alpha = 0.65, Flag = "Field Of View Color", Callback = function()
	...
	local esp = Window:Page({Name = "Renders"}) do 
		local playerEsp = esp:Section({Name = "Player Esp", Size = 330, Side = "Left"}) do 
			...
			highlight:Colorpicker({Default = Color3.fromHex(255,255,255), Transparency = 0.7, Flag = "PlayerESP_HighlightFillSettings"});
	...
	local Config = Window:Page({Name = "Settings"}) do
		...
		--
		local abc = false 
		Menu:Keybind({Name = "Menu key", Flag = "MenuKey", Default = Enum.KeyCode.V, Mode = "Toggle", Callback = function() abc = not abc Library:SetOpen(abc) end})
		Menu:Dropdown({Name = "Notification Position", Flag = "Notification Position", Options = {"Top Left", "Middle"}, Default = "Top Left"})
		Menu:Label({Centered = true, Name = "Credits: Light : Founder"})
		--
